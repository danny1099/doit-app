...
export const AvatarGroup = ({ items, max = 4, className }: AvatarGroupProps) => {
  return (
    <div className={cn("flex h-fit w-full items-center -space-x-1 px-1 py-2", className)}>
      ...
      {items.length > max && (
        <div className="bg-muted text-muted-foreground relative inline-flex size-9 items-center justify-center rounded-full border border-border align-middle text-xs font-medium">
